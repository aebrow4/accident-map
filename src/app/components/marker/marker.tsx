...
export default function Marker({
  ...
  const iconColor = isSelected ? 'red' : '#3FB1CE';
  ...
  return (
    <span className='absolute hovercontainer' style={{
      left: left - iconWidth / 2,
      top: top - iconHeight,
      zIndex: 1
    }}
        onClick={onClick}
      >
      <svg display='block' height={`${iconHeight}px`} width={`${iconWidth}px`} viewBox={`0 0 ${iconWidth} ${iconHeight}`}>
        ...
        <path fill={iconColor} d="M27,13.5C27,19.07 20.25,27 14.75,34.5C14.02,35.5 12.98,35.5 12.25,34.5C6.75,27 0,19.22 0,13.5C0,6.04 6.04,0 13.5,0C20.96,0 27,6.04 27,13.5Z"></path>
